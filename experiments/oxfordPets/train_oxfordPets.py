"""
Script to train a model to classify oxfordPets dataset.

:Description: script to train the oxfordPets task

:Authors: victor badenas (victor.badenas@gmail.com)

:Version: 0.1.0
:Created on: mié 27 oct 2021 16:19:51 CEST
"""

__title__ = "train_oxfordPets"
__version__ = "0.1.0"
...
class OxfordPetsTrainer(ClassifierTrainer):
